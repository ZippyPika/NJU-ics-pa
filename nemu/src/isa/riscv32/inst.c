...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  __VA_ARGS__ ; \
    ...
    INSTPAT("??????? ????? ????? 101 ????? 10100 11", srai, I, R(rd) = (word_t) ((sword_t)src1 >> (imm & 0x1f) ) );
    //R-type
    ...
    //INSTPAT("0000001 ????? ????? 010 ????? 01100 11",mulhsu, R, R(rd) = (sword_t)(((sword_t)src1 * (word_t)src2) >> 32));
    //INSTPAT("0000001 ????? ????? 011 ????? 01100 11",mulhu, R, R(rd) = (word_t)(((word_t)src1 * (word_t)src2) >> 32));
